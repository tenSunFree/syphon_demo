...
import 'package:syphon_demo/domain/settings/proxy-settings/model.dart';
...
abstract class Rooms {
  ...
  static Future<List<Photo>> fetchPhotos() async {
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint('Rooms, fetchPhotos, photoJsonList: ${photoJsonList.length}');
      return photoJsonList.map((json) => Photo.fromJson(json)).toList();
    } else {
