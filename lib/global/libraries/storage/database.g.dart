...
abstract class _$ColdStorageDatabase extends GeneratedDatabase {
  _$ColdStorageDatabase(QueryExecutor e) : super(e);
  _$ColdStorageDatabase.connect(DatabaseConnection c) : super.connect(c);
