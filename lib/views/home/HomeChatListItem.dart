...
import 'package:syphon_demo/domain/rooms/room/selectors.dart';
import 'package:syphon_demo/domain/settings/chat-settings/selectors.dart';
...
import 'package:syphon_demo/views/widgets/avatars/avatar.dart';
...
class HomeChatListItem extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final currentUser = useSelector<AppState, User>(
        (state) => state.authStore.user, const User());
