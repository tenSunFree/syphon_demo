...
ThemeSettings _$ThemeSettingsFromJson(Map<String, dynamic> json) =>
    ThemeSettings(
      primaryColor: json['primaryColor'] as int? ?? AppColors.cyanSyphon,
      accentColor: json['accentColor'] as int? ?? AppColors.cyanSyphon,
      appBarColor: json['appBarColor'] as int? ?? AppColors.cyanSyphon,
